...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=8CFkCIBB#k-GEsbllbYxoVfEi4I3qXghbnYU4oUU8psWC2CqTeyM' : process.env.SESSION_ID,
...
SESSION_NAME: process.env.PORT === undefined ? "session" : process.env.SESSION_NAME,
...
SONG_SEND_JID: process.env.SONG_SEND_JID === undefined ? "120363403023580180@newsletter" : process.env.SONG_SEND_JID,
